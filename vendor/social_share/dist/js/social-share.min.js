...
!function () {
    ...
    function n(t, e) {
        ...
        v(i ? r.reverse() : r, function (r) {
            var n = s(r, e), o = e.initialized ? d(t, "icon-" + r) : f('<a class="social-share-icon icon-' + r + '"></a>');
    ...
    function o(t, e) {
        ...
        var i = f('<div class="wechat-qrcode"><h4>' + e.wechatQrcodeTitle + '</h4><div class="qrcode"></div><div class="help">' + e.wechatQrcodeHelper + "</div></div>"), n = d(i[0], "qrcode", "div");
    ...
    var _ = Array.prototype.indexOf, C = Object.assign, E = /MicroMessenger/i.test(navigator.userAgent), A = e.documentElement.clientWidth <= 768, T = (e.images[0] || 0).src || "", y = c("site") || c("Site") || e.title, L = c("title") || c("Title") || e.title, D = c("description") || c("Description") || "", b = {
        url: location.href,
