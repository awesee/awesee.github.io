...
layout:     single
title:      "获取单值网格的最小操作数"
date:       2021-07-26 21:30:00 +0800
categories: [Leetcode]
tags:       [Array, Math, Matrix, Sorting]
permalink:  /problems/minimum-operations-to-make-a-uni-value-grid/
---

## 2033. 获取单值网格的最小操作数 (Medium)
...
## [解法](https://github.com/awesee/leetcode/tree/master/problems/minimum-operations-to-make-a-uni-value-grid)
