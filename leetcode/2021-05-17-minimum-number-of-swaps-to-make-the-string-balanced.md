...
layout:     single
title:      "使字符串平衡的最小交换次数"
date:       2021-05-17 21:30:00 +0800
categories: [Leetcode]
tags:       [Stack, Greedy, Two Pointers, String]
permalink:  /problems/minimum-number-of-swaps-to-make-the-string-balanced/
---

## 1963. 使字符串平衡的最小交换次数 (Medium)
...
## [解法](https://github.com/openset/leetcode/tree/master/problems/minimum-number-of-swaps-to-make-the-string-balanced)
