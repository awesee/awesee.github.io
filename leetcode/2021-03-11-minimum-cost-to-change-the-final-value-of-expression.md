...
layout:     single
title:      "反转表达式值的最少操作次数"
date:       2021-03-11 21:30:00 +0800
categories: [Leetcode]
tags:       [Stack, Math, String, Dynamic Programming]
permalink:  /problems/minimum-cost-to-change-the-final-value-of-expression/
---

## 1896. 反转表达式值的最少操作次数 (Hard)
...
## [解法](https://github.com/openset/leetcode/tree/master/problems/minimum-cost-to-change-the-final-value-of-expression)
