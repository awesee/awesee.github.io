...
layout:     single
title:      "检查操作是否合法"
date:       2021-05-12 21:30:00 +0800
categories: [Leetcode]
tags:       [Array, Enumeration, Matrix]
permalink:  /problems/check-if-move-is-legal/
---

## 1958. 检查操作是否合法 (Medium)
...
## [解法](https://github.com/openset/leetcode/tree/master/problems/check-if-move-is-legal)
