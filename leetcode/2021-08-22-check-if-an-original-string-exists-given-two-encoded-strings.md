...
layout:     single
title:      "同源字符串检测"
date:       2021-08-22 21:30:00 +0800
categories: [Leetcode]
tags:       [String, Dynamic Programming]
permalink:  /problems/check-if-an-original-string-exists-given-two-encoded-strings/
---
...
## [解法](https://github.com/awesee/leetcode/tree/master/problems/check-if-an-original-string-exists-given-two-encoded-strings)
