...
### 相关话题
  ...
  [[扫描线](https://github.com/awesee/leetcode/tree/master/tag/line-sweep/README.md)]
  [[堆（优先队列）](https://github.com/awesee/leetcode/tree/master/tag/heap-priority-queue/README.md)]

---

## [解法](https://github.com/awesee/leetcode/tree/master/problems/minimum-interval-to-include-each-query)
