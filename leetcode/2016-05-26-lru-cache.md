...
### 相关话题
  ...
  [[双向链表](https://github.com/awesee/leetcode/tree/master/tag/doubly-linked-list/README.md)]

### 相似题目
  1. [LFU 缓存](/problems/lfu-cache) (Hard)
  1. [设计内存文件系统](/problems/design-in-memory-file-system) (Hard)
  1. [迭代压缩字符串](/problems/design-compressed-string-iterator) (Easy)

---

## [解法](https://github.com/awesee/leetcode/tree/master/problems/lru-cache)
