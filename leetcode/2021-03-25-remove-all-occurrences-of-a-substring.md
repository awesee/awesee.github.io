...
categories: [Leetcode]
tags:       [String]
permalink:  /problems/remove-all-occurrences-of-a-substring/
---

## 1910. 删除一个字符串中所有出现的给定子字符串 (Medium)
...
## [解法](https://github.com/openset/leetcode/tree/master/problems/remove-all-occurrences-of-a-substring)
